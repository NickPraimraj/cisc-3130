The purpose of this program is to take data from the Spotify Top 200 charts and process it into something that can be used by other departments in the record label company 
